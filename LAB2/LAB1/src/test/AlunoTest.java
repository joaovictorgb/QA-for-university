...
class AlunoTest {
    ...
    public void setup() {
    	...
    	disciplina1 = new Disciplina("Matemática Discreta", "MAT123", 60);
    	disciplina2 = new Disciplina("Algoritmos e Estruturas de Dados", "ALG456", 90);
        aluno1.matricularDisciplina(disciplina1);
        aluno1.matricularDisciplina(disciplina2);
        disciplina3 = new Disciplina("Métodos Avançados de Programação", "MAP523", 90);
    }	
